...
DEFAULT_MODEL_FILE = SCRIPT_DIR / "coffee_xgboost_projection_rewritten.py"
...
def main() -> None:
    ...
    parser.add_argument("--model-file", type=str, default=str(DEFAULT_MODEL_FILE), help="Path to coffee_xgboost_projection_rewritten.py")
